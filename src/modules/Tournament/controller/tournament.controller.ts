...
export class TournamentsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Participants have been successfully added.',
  })
  @ApiParam({ name: 'id', required: true, description: 'Tournament ID' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Matchups have been successfully generated.',
  })
  @ApiParam({ name: 'id', required: true, description: 'Tournament ID' })
  ...
  getMatchResults(
    ...
    return this.tournamentsService.getMatchResults(
      +id,
      minScore,
      page,
      limit,
