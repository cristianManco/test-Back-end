...
export class ResultController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The match result has been successfully created.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The match result has been obtained',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The match result has been successfully deleted.',
  })
  @ApiParam({ name: 'id', required: true, description: 'Match result ID' })
